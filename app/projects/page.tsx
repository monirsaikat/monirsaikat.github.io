    ...
    <div className="mx-auto max-w-5xl px-6 py-20">
      ...
      <div className="mb-16">
        ...
        <p className="text-text max-w-xl leading-relaxed">
          ...
          {" "}plus two live products. Systems work, web tooling, desktop apps, and everything in between.
        </p>
      ...
      <div className="mb-16">
        <div className="flex items-center gap-3 mb-6">
          <h2 className="font-mono text-xs text-green tracking-widest uppercase">Featured</h2>
          <span className="font-mono text-xs text-muted">({featured.length} projects)</span>
        </div>
      ...
      <div className="mb-16">
        <div className="flex items-center gap-3 mb-6">
          <h2 className="font-mono text-xs text-muted tracking-widest uppercase">More Projects</h2>
          <span className="font-mono text-xs text-muted">({others.length} projects)</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {others.map((project) => (
            <ProjectCard key={project.slug} project={project} />
      ...
      <div className="rounded-xl border border-border bg-surface p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
          <p className="font-mono text-xs text-muted uppercase tracking-widest mb-1">// and many more</p>
